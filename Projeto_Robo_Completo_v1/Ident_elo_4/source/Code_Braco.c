...
void rotina_interrupcao_1() {
	...
	if (k > 0 && k < tempo_ident) {
		...
		atualizar_motor_4(valor_prbs[amostra]);
		k = tempo_ident;
		amostra++;
	}

	calcular_angulo(&acc_1);
	valor_1 = 10000 * acc_1.angGz_atual;
	valor_2 = 10000 * acc_1.ang_pitch_x;
	valor_3 = 10000 * acc_1.ang_pitch_y;
	valor_4 = 10000 * acc_1.ang_pitch_z;
	fusao = 10000 * fused;
...
int main(void) {
	...
	inicializar_PWMs();
	atualizar_motores(4500,4350,7000);
	delay(10000);
