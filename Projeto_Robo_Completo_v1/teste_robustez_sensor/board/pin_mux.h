...
/*! @name PORTA3 (number 29), J6[2]/U4A[3]/U4C[9]/SWD_DIO_TGTMCU
  @{ */
#define BOARD_INITPINS_sensor_ligar_FGPIO FGPIOA /*!<@brief FGPIO device name: FGPIOA */
#define BOARD_INITPINS_sensor_ligar_GPIO GPIOA /*!<@brief GPIO device name: GPIOA */
#define BOARD_INITPINS_sensor_ligar_PORT PORTA /*!<@brief PORT device name: PORTA */
#define BOARD_INITPINS_sensor_ligar_PIN 3U     /*!<@brief PORTA pin index: 3 */
                                               /* @} */
